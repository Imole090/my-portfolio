  ...
  return (
    <div className="w-full h-full flex flex-col bg-card">
      <div className="h-8 flex items-center gap-2 px-3 border-b border-border shrink-0">
        ...
        <span className="ml-2 font-mono-custom text-[9px] text-muted-foreground truncate">{name}</span>
      </div>
    ...
    <BrowserFrame name={name}>
      <div className="flex h-full">
        <div className="w-12 border-r border-border p-2.5 flex flex-col gap-3 shrink-0">
          <div className="w-5 h-5 rounded bg-primary/70 flex items-center justify-center">
    ...
    <BrowserFrame name={name}>
      <div className="h-full flex flex-col">
        <div className="p-2.5 border-b border-border flex items-center gap-2">
          <span className="font-display text-[11px] font-black shrink-0">{name.split(" ")[0]}</span>
              ...
              <Reveal key={proj.id} delay={i * 80}>
                ...
                >
                  <div className="aspect-[4/3] overflow-hidden bg-card relative">
                    <div className="w-full h-full opacity-85 group-hover:opacity-100 group-hover:scale-[1.02] transition-all duration-700">
            ...
            <Reveal key={proj.id} delay={i * 50}>
              <div className="group bg-background cursor-pointer" onClick={() => openProject(proj.id)}>
                <div className="aspect-video overflow-hidden bg-card">
                  <div className="w-full h-full opacity-80 group-hover:opacity-100 group-hover:scale-[1.02] transition-all duration-600">
                    <ProjectMockup type={proj.mockup} name={proj.title} />
                  </div>
                </div>
                <div className="p-7">
            ...
            {PROJECTS.map((proj) => (
              ...
              >
                ...
                <div className="aspect-video rounded-xl overflow-hidden bg-card">
                  <div className="w-full h-full opacity-75 group-hover:opacity-95 transition-opacity duration-500">
                    <ProjectMockup type={proj.mockup} name={proj.title} />
                  </div>
                </div>
              </div>
